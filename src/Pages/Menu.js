...
function Menu() {
  ...
  // Get the logged-in customer number from localStorage
  const custNb = localStorage.getItem('custNb');
  
  if (!custNb) {
    alert('You must be logged in to place an order. Please login first.');
    return;
  }
  ...
  try {
    ...
    if (response.ok && result.orderId) {
      // Success - show confirmation and clear the order
      alert(
    ...
    <div className="page menu-page">
      ...
      <div className="order-section">
        ...
        <div className="order-controls">
          ...
          <button
            type="button"
            className="cta-button order-submit-btn"
            onClick={handleOrder}
